...
cl.login(token="Eynn3hC1nK15EwhzvAa0.9q2iIcfJltjghJCvoSD1Wa.dOG48KKENEmYgLQzDlPqF0hy78NQ0JeXB/yJ8uHoMas=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(token="Eyfg6QGFHBFUFC8ZtkZ5.BAbZE0umy2dUOSbpoBpzPq.lXD2kRtVC24dED2mukQS8SWJq69jiPdbdSwYttfrEQg=")
ki.login(token="EycbrsmBM143BoKaLM75.BAbZE0umy2dUOSbpoBpzPq.IzMafCst0ehLrK4J6nbYDi4SY3nXQIhy+N5N/rzgP0M=")
ki.loginResult()

kk = LINETCR.LINE()
#kk.login(token="Ey870DEVeRttxWG0kULc.YCFgbMZPhmkVN+eVj380ta.iJVSxeD+bc4PA1LUDs7vsCeCDLPRUCzX4+9TVC4HQfE=")
kk.login(token="EySTDV9VR21dW5JYiTWc.YCFgbMZPhmkVN+eVj380ta.272Q3xuZC5wv4cdAu12Ss+gpcsUN7qTs1A3VjDMrJmc=")
kk.loginResult()

kc = LINETCR.LINE()
#kc.login(token="EyAO2wLu8PnLKEIxWZQf.jcKRHQZO/ZUdXspu91JKJW.qIV6DwN1HjPrUW6pq0JghQDflEV0c/mlCsPIn3SG/zM=")
kc.login(token="EyAt9HlCxnVgfKSLYZZf.jcKRHQZO/ZUdXspu91JKJW.YEXAMxYJaQFaR+9WU+4P8PdYQhbX1ycjEDo1K8NVc3g=")
kc.loginResult()

kb = LINETCR.LINE()
#kb.login(token="EyCivT3oBbQGe4azowY2.a3wwcrKoF7GSYZK8iLIneG.P2ZAwWDZRfny1TV8lUIguyLE+N19zD7Fb6KPLEv/H3w=")
kb.login(token="EyzelW0IWSnrrhYVF462.a3wwcrKoF7GSYZK8iLIneG.d50iiXRy5Pf0h4STDBpQqjjDwuI5jeD3kWKAa4K9YZg=")
kb.loginResult()

kd = LINETCR.LINE()
#kd.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kd.login(token="Ey8QnS1sFTnbjMMAsdEc.lRANtBt0XNe7AUiARUwHRa.uDxvRQQhLyNvHwJuXROK3epg7k5O5iaeDlwVd0Ny6ZE=")
kd.loginResult()

ke = LINETCR.LINE()
#ke.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
ke.login(token="EynoZWw7dRNLIE14U2o2./LjutxDotUFL1qqbWYLg0G.qLOYwzww0ARLxE7qms6Y/96W2h56hM1m+HIwmuhWWIY=")
ke.loginResult()

kg = LINETCR.LINE()
#kg.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kg.login(token="EyBcm6Cqq7WLcouIREKb.d+8dm1wfnENnVH33/TFNkW.fkDasRPOLaTXXXzjOalhYY+4h75hROhtHEjyOss6Cfw=")
kg.loginResult()

kh = LINETCR.LINE()
#kh.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kh.login(token="EyYKv1gmeV8Wfxq4qmi4.q5eKTus+y7F5Lcc39+6ADa.FjsMRt9gh0N2lQhg8iK4PVN3OZg/yj4VOU/hyz9MH/Y=")
kh.loginResult()

kl = LINETCR.LINE()
#kl.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kl.login(token="Ey6cuUwXuhWgDZXx8pbc.z4y1C6W70neuRJnWGivNZa.FjRvTORKu1ISlObVSNEse+BJ2ogPWkUy6pspjAKWe0Q=")
kl.loginResult()

kt = LINETCR.LINE()
#kt.login(token="
kt.login(token="EyHPdHEj1gO3Uj5KsJs6.fil0fVEpy07SxIHYe/xGrG.lf+CVPkr14iVc5LWfTSE9jIThDwkkuPLXsZulTiYMjM=")
kt.loginResult()

kz = LINETCR.LINE()
#kz.login(token="
kz.login(token="Eyor92VO8SBqeAUvxmV9.pzD1VRZEG6ip2fZxru4LIq.73jTQfDDGqfMsGYeOPQpFNdlhvzQt9m1nlgeur8AZKk=")
kz.loginResult()

sw = LINETCR.LINE()
#sw.login(token="
sw.login(token="EyKAiRRPRJbG5XovEGe0.wa8B30bh0DW1uW057OP4ma.2k4f6Qcoo3AijF+rR0ge5kPmevFwExZ+uVw1vAfiy78=")
sw.loginResult()
...
#-----------------------------------------------------------------
        if op.type == 13:
            if mid in op.param3:
                klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kl]
                kicker = random.choice(klist)
                G = kicker.getGroup(op.param1)
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
...
#-----------------------------------------------
		...
		kg.sendText(msg.to, s7.displayName + " ready 􀜁􀅔Har Har􏿿")
                ...
                kl.sendText(msg.to, s9.displayName + " ready 􀜁􀅔Har Har�")
#-----------------------------------------------
...
#-----------------------------------------------
	      ...
	      if msg.from_ in admin:
                ...
                ke.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs up�" % (elapsed_time))
                kg.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs up�" % (elapsed_time))
                kh.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs up�" % (elapsed_time))
                kl.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs up�" % (elapsed_time))
              else:
               	  msg.contentType = 13
                  msg.contentMetadata = {"mid": msg.from_}
                  cl.sendMessage(msg)
